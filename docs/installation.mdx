...
Compose files against the release manifest. Set `TECHULUS_CLOUD_VERSION=tip`
before running the script only when you explicitly want the unverified rolling
channel.
