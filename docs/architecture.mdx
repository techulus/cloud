...
graph TD
    ...
    CP -->|"Protection tag management"| GAR
...
runtime teardown and release of its GAR protection tags. GAR cleanup policies
remove unprotected image versions asynchronously.
