...
Stateful services can use serverless scaling when they have a public HTTP domain
and manual placement on a proxy node. Automatic serverless placement is only
available to stateless services without volumes.
