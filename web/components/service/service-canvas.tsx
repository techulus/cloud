...
function ServiceCardSkeleton() {
	return (
		<div className="flex flex-col items-stretch gap-2 w-full md:w-70">
			<div className="flex min-h-30 w-full flex-col p-3 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-100/50 dark:bg-slate-800/50">
	...
	return (
		<div className="flex flex-col items-stretch gap-2 w-full md:w-70">
			<Link
				...
				className={`
          group relative flex min-h-30 w-full flex-col
